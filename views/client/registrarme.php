<div class="modal fade" id="RegistrarmeModal" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="information-wrapper">
                                <div class="first-row form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input class="billing-address-name form-control" type="text" name="dni" placeholder="Obligatorio">
                                    </div>
